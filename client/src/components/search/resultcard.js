    ...
    return (
        <div className="card-holder">
            ...
            <div className="due-amount">
                <label className="due-label">Due:</label><p className="due">{props.resultcard.due}</p>
                <label className="amount-label">Amount:</label><p className="amount"> {props.resultcard.amount}</p>
            </div>
